...
class InterfaceBox(Box):
    ...
    def __init__(self, intf: EngineInterface, view: 'View'):
        ...
        self.debug_button = Button(40 * self.view.gui_scale, 40 * self.view.gui_scale, None, "i", "Arial " + str(int(self.view.gui_scale * 20)),
                                   on_press=lambda x, y: self.on_press_debug())
        self.rx_button = Button(40 * self.view.gui_scale, 40 * self.view.gui_scale, None, "RX", "Arial " + str(int(self.view.gui_scale * 20)),
                 on_press=lambda x, y: self.on_press_rx_button())
        self.tx_button = Button(40 * self.view.gui_scale, 40 * self.view.gui_scale, None, "TX", "Arial " + str(int(self.view.gui_scale * 20)),
    ...
    def on_paint(self, offs_x: int, offs_y: int):
        ...
        if rot in [1, 3]:
            angle = 90
        self.view.create_text(abs_x + self.width / 2 * self.view.zoom, abs_y + self.height / 2 * self.view.zoom, self.intf.component.name,
